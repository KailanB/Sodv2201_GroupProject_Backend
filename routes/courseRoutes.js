...
import { getCourses, getCoursesOfProgram, getCoursesOfUser, deleteCoursesOfUser, createCourse, updateCourse, deleteCourse } from '../controllers/courseController.js';
...
router.delete('/courses/student/:studentId/:courseId', authenticateToken, deleteCoursesOfUser)
